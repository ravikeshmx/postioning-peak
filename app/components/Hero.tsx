  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 py-32 relative">
      <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            {socialLinks.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="w-10 h-10 rounded-full border border-[var(--border)] flex items-center justify-center text-[var(--text-secondary)] hover:text-[var(--accent)] hover:border-[var(--accent)] transition-all duration-300"
        ...
        >
          We build your presence. You build your product.
        </motion.p>
        ...
        >
          ...
          <a
            href="#contact"
            className="px-8 py-4 border-2 border-[var(--accent)] text-[var(--accent)] font-semibold rounded-full hover:bg-[var(--accent)] hover:text-[var(--background)] transition-all duration-300"
          >
            Book a Call
          </a>
        </motion.div>
